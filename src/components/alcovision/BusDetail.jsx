    ...
    <>
      <Toast onClose={() => setShow(false)} show={show} delay={3000} style={{
        ...
        zIndex:"9999999"
          ...
          <Toast.Header>
            <strong className="me-auto">Alert Baru</strong>
            <small>Bus 1</small>
          </Toast.Header>
          <Toast.Body>Sopir tidak fokus ke jalan</Toast.Body>
        </Toast>
            ...
            <div className="card-body" style={{ minHeight: '38em' }}>
              <div className="details">
                ...
                <h6 className="text-capitalize">
                  Rute &emsp;&emsp;&emsp;&emsp;: {data.bus[0]?.bus_route}
                </h6>
                <h6 className="text-capitalize">
                  Informasi &emsp;&nbsp; : {data.bus[0]?.information}
                </h6>
              </div>
              <a
              ...
              <h5 className="mb-3 mt-5">Daftar Peringatan (LIVE)</h5>
                    ...
                    {data.alerts[0]?.id ? (
                      data.alerts?.map((alert, i) => (
                        <tr>
                          ...
                          <td className='text-dark'>{alert.category}</td>
                          <td className="text-end">
                            <div>
                              <button
                                className="btn btn-dark p-0 me-3"
                                type="button"
